/*
 * Taken from https://github.com/JetBrains/intellij-plugins/blob/master/qodana/core/tests/org/jetbrains/qodana/dispatch.kt
 */
 ...
 */
private fun dispatchAllTasksOnUi() = PlatformTestUtil.dispatchAllInvocationEventsInIdeEventQueue()
